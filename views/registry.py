"""Central route registry for visible and compatibility pages."""
...
PAGE_RENDERERS: dict[str, PageRenderer] = {
    ...
    "AED Map": partial(render_aed_map_page, aed_csv_file=AED_DATA_FILE),
    "PM Planning": partial(render_pm_planning_page, aed_csv_file=AED_DATA_FILE),
    ...
    "Issues": partial(render_issues_page, issue_csv_file=ISSUE_RECORD_FILE),
}


def render_current_page(page_name: str) -> None:
    PAGE_RENDERERS.get(page_name, PAGE_RENDERERS["Operations Dashboard"])()
