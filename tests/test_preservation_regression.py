...
def test_management_and_master_table_are_separate_sidebar_pages():
    ...
    assert '("AED Master Table", "▦  Master Table")' in source
...
def test_master_table_keeps_all_original_workflows_on_its_own_page():
    ...
    assert '"AED Management"' in source
    assert '"AED Master Table"' in source
    ...
    assert '"Open Master Table"' in source
    assert '"AED Management scope"' not in source
