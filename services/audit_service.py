...
TRANSACTION_COLUMNS = ['Operation ID', 'Operation Type', 'User', 'Session ID', 'Serial Numbers', 'Source Page', 'Started At', 'Finished At', 'Result', 'Final Step', 'Message']
AUDIT_COLUMNS = ['Operation ID', 'Timestamp', 'User', 'Session ID', 'Operation Type', 'Source Page', 'Serial Number', 'Field', 'Original Value', 'Current Value', 'Desired Value', 'Result', 'Message']
